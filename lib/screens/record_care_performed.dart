...
class RecordCarePerformedScreen extends StatefulWidget {
  static String routeName = '/record-care-performed';
  const RecordCarePerformedScreen({Key? key}) : super(key: key);

  @override
  RecordCarePerformedScreenState createState() => RecordCarePerformedScreenState();
}


class RecordCarePerformedScreenState extends State<RecordCarePerformedScreen>with SingleTickerProviderStateMixin {
            ...
            child: Column(
              ...
              children: [
                ...
                Row(
                  children: const [
                    SizedBox(width: 20.0,),
                    Text("Selecciona la actividad que se realizó:"),
