...
class PharmacotherapyScreen extends StatefulWidget {
  static String routeName = '/pharmacotherapy';
  const PharmacotherapyScreen({Key? key}) : super(key: key);

  @override
  PharmacotherapyScreenState createState() => PharmacotherapyScreenState();
}


class PharmacotherapyScreenState extends State<PharmacotherapyScreen>with SingleTickerProviderStateMixin {
