...
class LastMedicationGivenScreen extends StatefulWidget {
  static String routeName = '/last-medication-given';
  const LastMedicationGivenScreen({Key? key}) : super(key: key);

  @override
  LastMedicationGivenScreenState createState() => LastMedicationGivenScreenState();
}


class LastMedicationGivenScreenState extends State<LastMedicationGivenScreen>with SingleTickerProviderStateMixin {
                  ...
                  child: Row(
                    children: [
                      ...
                      UIHelper.getElevatedButton(
                        20.0,
                        "Ultimo medicación administrada",
                        280.0,
                        35.0,
